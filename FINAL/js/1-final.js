...
var objLoading = function(){
	...
	// loaderFBX.load(
	// 	'assets/Pug.fbx',//arquivo que vamos buscar
	// 	function(obj){
	...
	// 					 	map: new THREE.TextureLoader().load("assets/texturas/Pug_texture.png")}
	// 					 );
	...
	//Load do Wolf
	loaderFBX.load(
		'assets/wizard-3d-model/Animation/Wizard_Idle.fbx',//arquivo que vamos buscar
		function(obj){
			//atribui a cena, colore, reposiciona, rotaciona
			elementos['wolf'] = obj;
			...
			loaderFBX.load(
						'assets/wizard-3d-model/Animation/Wizard_Jump.fbx', //arquivo que vamos carregar
						function(object){
							...
							loaderFBX.load(
								'assets/wizard-3d-model/Animation/Wizard_Damage.fbx', //arquivo que vamos carregar
								function(object){
									let animationAction = mixer.clipAction((object).animations[0]);
									animationActions.push(animationAction)         
									...
									loaderFBX.load(
										'assets/wizard-3d-model/Animation/Wizard_Walking.fbx', //arquivo que vamos carregar
										function(object){
											let animationAction = mixer.clipAction((object).animations[0]);
											animationActions.push(animationAction)         
											activeAction = animationAction;
											setAction(animationAction);
											loaderFBX.load(
												'assets/wizard-3d-model/Animation/Wizard_Attack.fbx', //arquivo que vamos carregar
												function(object){
													let animationAction = mixer.clipAction((object).animations[0]);
													animationActions.push(animationAction)         
													activeAction = animationAction;
													setAction(animationAction);
													loaderFBX.load(
														'assets/wizard-3d-model/Animation/Wizard_Dead.fbx', //arquivo que vamos carregar
														function(object){
															let animationAction = mixer.clipAction((object).animations[0]);
															animationActions.push(animationAction)         
															activeAction = animationAction;
			...
			obj.traverse( function (child){
					...
					if (child instanceof THREE.Mesh){
						...
						child.material.map = new THREE.TextureLoader().load("assets/wizard-3d-model/UVWizard.png");
